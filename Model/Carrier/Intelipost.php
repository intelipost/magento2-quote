    ...
    implements \Magento\Shipping\Model\Carrier\CarrierInterface
{
    ...
    public function collectRates(RateRequest $request, $pickup = false)
    {
        ...
        foreach ($response ['content']['delivery_options'] as $child)
        {
            ...
            $method->setMethodTitle($this->_helper->getCustomCarrierTitle ($child ['description'], $child ['delivery_estimate_business_days'], $schedulingEnabled,$this->_code));
            $method->setMethodDescription($this->_helper->getCustomCarrierTitle($child['delivery_method_name'], $child['delivery_estimate_business_days'], $schedulingEnabled,$this->_code));
